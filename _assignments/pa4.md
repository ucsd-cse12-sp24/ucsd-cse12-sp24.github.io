...
The starter code is at [here](https://github.com/ucsd-cse12-sp24/cse12-pa4-runtime). If you are not familiar with Github, here are two easy ways to get your code.
...
<img width="434" alt="Add Jar Manually" src="images/addjar.png">

* Select the mysteries.jar file in the starter code under the src folder.
  
<img width="500" alt="Add Jar Manually" src="images/selectjar.png">
...
<img width="578" alt="turn-off-optimisation" src="images/optimisation.png">
